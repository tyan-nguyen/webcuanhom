...
use app\modules\template\models\TemplateSearchAjax;
...
/**
 * TemplateAjaxController implements the CRUD actions for Template model.
 */
class TemplateAjaxController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new TemplateSearchAjax();
  		if(isset($_POST['search']) && $_POST['search'] != null){
            $dataProvider = $searchModel->search(Yii::$app->request->post(), $_POST['search']);
        } else if ($searchModel->load(Yii::$app->request->post())) {
            $searchModel = new TemplateSearchAjax(); // "reset"
