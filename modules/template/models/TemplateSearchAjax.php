...
/**
 * TemplateSearchAjax represents the model behind the search form about `app\modules\template\models\Template`.
 */
class TemplateSearchAjax extends Template
{
    /**
     * @inheritdoc
     */
