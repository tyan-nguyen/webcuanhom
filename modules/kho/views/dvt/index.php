...
/* @var $searchModel app\modules\kho\models\search\DonViTinhSearch */
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới đơn vị tính','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="don-vi-tinh-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách đơn vị tính'
            ]
        ])?>
    </div>
</div>
