...
/* @var $searchModel app\modules\kho\models\search\ThuongHieuSearch */
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới Thương hiệu','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="thuong-hieu-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách Thương hiệu'
            ]
        ])?>
    </div>
</div>
