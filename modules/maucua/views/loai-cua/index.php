...
/* @var $searchModel app\modules\maucua\models\search\LoaiCuaSearch */
...
BulkButtonWidget::widget([
    ...
    Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
        ['role'=>'modal-remote','title'=> 'Thêm mới loại cửa','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
        '&nbsp;' .
...
<div class="loai-cua-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fas fa fa-list" aria-hidden="true"></i> Loại cửa',
