...
/* @var $searchModel app\modules\maucua\models\search\DanhGiaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh Gias';
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới Danh Gias','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="danh-gia-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách Danh Gias'
            ]
        ])?>
    </div>
</div>
