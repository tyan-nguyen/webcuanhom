...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
        	...
        	<td style="vertical-align:middle"><?= $form->field($model, 'nhomDu['.$nsd->id.']')->textInput(['value'=>$nsd->chieu_dai_con_lai, 'disabled'=>($model->status=="DA_XUAT_KHO"?false:true), 'style'=>'width:80px'])->label(false) ?></td>
        </tr>
        <?php } ?>
    </tbody>
</table>
