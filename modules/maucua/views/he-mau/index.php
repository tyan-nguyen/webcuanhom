...
/* @var $searchModel app\modules\maucua\models\search\HeMauSearch */
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới Hệ màu','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="he-mau-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách Hệ màu'
            ]
        ])?>
    </div>
</div>
