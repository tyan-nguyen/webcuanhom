...
/* @var $searchModel app\modules\maucua\models\search\LoaiBaoGiaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Loại báo giá';
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới Loại báo giá','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="loai-bao-gia-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách Loại báo giá'
            ]
        ])?>
    </div>
</div>
