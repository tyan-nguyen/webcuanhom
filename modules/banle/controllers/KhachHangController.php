...
use app\modules\banle\models\search\KhachHang as KhachHangSearch;
...
class KhachHangController extends Controller
{
	...
	/**
	 * refresh data in dropdownlist khach-hang
	 */
	public function actionRefreshData($selected){
        ...
        if($vts != null){
            foreach ($vts as $vt){
                $options .= '<option value="'. $vt->id .'" '. ($vt->id==$selected ? 'selected' : '') .'>'. $vt->ten_khach_hang .'</option>';
            }
            $options .= '</optgroup>';
        }
