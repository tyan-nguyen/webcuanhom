...
/* @var $searchModel app\modules\banle\models\search\KhachHang */
...
<div id="dToolbar">
	<?=		BulkButtonWidget::widget([
            ...
            Html::a('<i class="fa-solid fa-square-plus"></i> Thêm mới (A)', ['create'],
                ['role'=>'modal-remote','title'=> 'Thêm mới Khach Hangs','class'=>'btn btn-primary btn-sm btn-default-custom', 'accesskey'=>'a']).
                '&nbsp;' .
...
<div class="khach-hang-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                'heading' => '<i class="fa-brands fa-windows"></i> Danh sách Khách hàng'
            ]
        ])?>
    </div>
</div>
