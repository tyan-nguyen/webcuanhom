...
use app\widgets\Editvar2;
use app\widgets\Editblock2;
    ...
    public function showEdit($type, $name){
        if($type == ThemeControl::TYPE_VAR){
            ...
            if($varible != null){
                ...
                if($wVar != null){
                    return Editvar2::widget(['id'=>$wVar->id, 'value'=>$wVar->value]);
                }
            }
            ...
            if($block != null){
                ...
                if($wBlock != null){
                    return Editblock2::widget(['id'=>$wBlock->id, 'content'=>$wBlock->content]);
                }
            }
        }
    }
